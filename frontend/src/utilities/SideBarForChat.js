...
export const SideBarForChat = (props) => {
    ...
    return (
        ...
        <div className="flex bg-gray-900">
            <div className="flex flex-col border-r-2 overflow-y-auto">
                <div className="border-b-2 py-4 px-2 flex items-center">
                    <input
                        type="text"
                        placeholder="search chatting"
                        ...
                        onChange={(e) => setSearchInput(e.target.value)}
                    />
                    <button className="flex items-center justify-center rounded-full w-10 h-10 focus:outline-none focus-visible:ring-2" onClick={HandleNewListItem}>
